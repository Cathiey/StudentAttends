...
if (isset($_POST['submit'])) {
    ...
    if (strlen($studentNumber) != 9 || !ctype_digit($studentNumber)) {
        echo "<script>alert('Username must be exactly 9 digits.');</script>";
    } else {
...
<div class="floating-shapes">
    ...
    <div class="wrapper">
        ...
        <div class="input-box">
    <input type="text" name="studentNumber" placeholder="Username" pattern="\d{9}" title="Username must be exactly 9 digits" required>
    </div>
            <div class="input-box">
            ...
            <div class="text">
                <a href="http://localhost/StudentAttends/ForgotPassword.php">Forgot Password<br></a>
