...
if (isset($_POST['submit'])) {
    ...
    // Check credentials
    $stmt = $conn->prepare("SELECT password FROM Lecturers WHERE staffNo = ?");
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<script>alert('Invalid staff number');</script>";
    }
...
<head>
    ...
    <style>
        ...
        *{
        ...
        .shape1 { width: 80px; height: 80px; top: 5%; left: 23%; animation-duration: 8s; }
        .shape2 { width: 90px; height: 90px; top: 35%; left: 3%; animation-duration: 10s; }
        .shape3 { width: 100px; height: 100px; top: 65%; left: 17%; animation-duration: 12s; }
        .shape4 { width: 80px; height: 80px; top: 5%; left: 70%; animation-duration: 8s; }
        .shape5 { width: 90px; height: 90px; top: 35%; left: 90%; animation-duration: 10s; }
        .shape6 { width: 100px; height: 100px; top: 65%; left: 75%; animation-duration: 12s; }
...
<body>
    ...
    <div class="wrapper">
        ...
        <form action="staffLogin.php" method="POST">
            <div class="input-box">
                <input type="text" name="staffNo" placeholder="Username" required>
            </div>
            <div class="input-box">
            ...
            <div class="text">
                <a href="http://localhost/StudentAttends/AFPassword.php">Forgot Password<br></a>
            </div>
        </form>
    </div>
</body>
